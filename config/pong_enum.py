...
class PathEnum(Enum):
    ...
    SRC_SOUND_ENUM: str = 'src/sound/'
    WHITE_SOUND_PATH_ENUM: str = SRC_SOUND_ENUM + 'chill.mp3'
...
class ButtonNamesEnum(Enum):
    ...
    CHANGE_BALL_BTN_ENUM: str = 'Change Ball'
    RETURN_TO_MENU_BTN_ENUM: str = 'Back to Main Menu'
